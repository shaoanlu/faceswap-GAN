...
* Training data: 5k/9k face images for each target. Raw materials are scrawled from pinterest and youtube, and then cropped using dlib. Face alignment is not applied on training data.
