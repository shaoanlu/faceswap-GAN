...
* [FaceSwap_GAN_github.ipynb](https://github.com/shaoanlu/faceswap-GAN/blob/master/FaceSwap_GAN_github.ipynb): This jupyter notebook does the following jobs:
  ...
  **Updated 29, Dec., 2017:** A smoothed bounding box method is added in section "making video clips w/o face alignment". See the below gif for comparison: The noticeble jittering on the swapped faces is eliminated in the smoothed bounding box version.
