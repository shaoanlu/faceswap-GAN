...
- **Consistent eyeballs direction (v2.2 model):** Results of an updated v2 model which specialized on eyeballs' direcitons is presented below. Gifs are created using online demo of [DeepWarp project](http://163.172.78.19/). 
