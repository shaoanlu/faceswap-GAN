...
- **Consistent eyeballs (v2.2 model):** Results of the v2.2 model which specializes on eyeballs' direcitons are presented below. V2.2 model achieve better eyes generation within shorter iteation. (Input gifs are created using [DeepWarp](http://163.172.78.19/).) 
