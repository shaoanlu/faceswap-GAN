...
- **Additional results:** [This image](https://www.dropbox.com/s/mhz4nfbh7s6ot9z/random160.jpg?raw=1) shows 160 random results generated by v2 GAN with self-attention mechanism (image format: source -> mask -> transformed).

###### The Trump/Cage images are obtained from the [original deepfakes project](https://pastebin.com/hYaLNg1T) on pastebin.com.
